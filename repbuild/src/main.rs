//! original code found here: https://git.ablecorp.us/AbleOS/ableos/src/branch/master/repbuild/src/main.rs
...
fn build(release: bool) -> Result<(), Error> {
    ...
    com.current_dir("programs");
    com.args(["b", "--bin", "first"]);
